package ee.tenman.stocks.xirr.exception;

import ee.tenman.stocks.xirr.NewtonRaphson;
...
public class OverflowException extends ArithmeticException {
    ...
    public OverflowException(String message, NewtonRaphson.Calculation state) {
        super(message);
        this.state = state;
    }
